...
#         self.bodies: dict[str, BlockNodeData] = {}
# 
#         self.footnotes_lists: list[FootnotesNodeData] = []
# 
#         self.footnote_unique_id_function = (
#             footnote_unique_id_function or default_footnote_unique_id
#         )
# 
#     def add_footnote(self, footnote: FootnoteNodeData):
#         """Add a single footnote to the list
#         of managed footnotes."""
#         self.footnotes.append(footnote)
# 
#     def add_footnotes(self, footnotes: list[FootnoteNodeData]):
#         """Add a list of footnotes to the list
#         of managed footnotes."""
#         self.footnotes.extend(footnotes)
# 
#     def add_body(self, name: str, data: BlockNodeData):
...
# 
#     def add_footnotes_list(self, data: FootnotesNodeData):
