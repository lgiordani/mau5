...
class HtmlVisitor(JinjaVisitor):
    ...
    #         markers.append(self.visit(line.marker, *args, **kwargs))
    ...
    #         # There might be lines marked as highlighted using Mau's syntax.
    #         highlight_markers = [line.number for line in node.code if line.highlight]
    ...
    #     result["code"] = list(zip(result["code"], markers))
