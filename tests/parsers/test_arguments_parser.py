...
#     expected_nodes = [
#         Node(
#             data=ValueNodeData("value with spaces"),
...
#     expected_nodes = [
#         Node(
#             data=ValueNodeData("value1 with spaces"),
#             info=NodeInfo(context=generate_context(0, 0, 0, 18)),
#         ),
#         Node(
#             data=ValueNodeData("value2 with more spaces"),
...
#     expected_nodes = [
#         Node(
#             data=ValueNodeData("value1,value2"),
...
#         ),
#         "name2": Node(
#             data=ValueNodeData("value2 with spaces"),
...
#     expected_nodes = {
#         "name": Node(
#             data=ValueNodeData('value "with quotes"'),
...
#     expected_nodes = {
#         "name": Node(
#             data=ValueNodeData('value "with escaped quotes"'),
...
#     expected_named_nodes = {
#         "key1": Node(
#             data=ValueNodeData("originalvalue1"),
