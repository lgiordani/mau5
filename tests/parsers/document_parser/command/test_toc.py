...
#     def _header_internal_id(data: HeaderNodeData) -> str:
...
#     )
# 
#     toc_item_1_1 = TocItemNodeData(header=header_1_1)
# 
#     toc_item_1 = TocItemNodeData(header=header_1, entries=[toc_item_1_1])
# 
#     toc_item_2 = TocItemNodeData(header=header_2)
# 
#     node_toc = Node(
#         data=TocNodeData(
#             nested_entries=[
