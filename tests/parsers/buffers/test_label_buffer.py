...
def test_title_buffer_push_and_pop():
    ...
    compare_nodes(children["title"], [test_node])
...
def test_title_buffer_push_multiple_children():
    ...
    compare_nodes(children["title"], [test_node_title])
    compare_nodes(children["source"], [test_node_source])
...
def test_title_buffer_push_twice_the_same_position():
    ...
    compare_nodes(children["title"], [test_node_title2])
