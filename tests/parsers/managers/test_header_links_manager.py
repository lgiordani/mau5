...
def test_internal_links_manager():
...
def test_internal_links_manager_no_link():
    ilm = HeaderLinksManager()
...
def test_internal_links_manager_no_header():
    ilm = HeaderLinksManager()
...
def test_internal_links_manager_duplicate_header():
    ilm = HeaderLinksManager()
...
def test_internal_links_manager_update():
