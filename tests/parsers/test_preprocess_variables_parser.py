...
#     expected_nodes = [
#         Node(
#             data=TextNodeData("This is number 5"),
...
#     expected_nodes = [
#         Node(
#             data=TextNodeData("This is {attr"),
...
#     expected_nodes = [
#         Node(
#             data=TextNodeData("This flag is "),
...
#     expected_nodes = [
#         Node(
#             data=TextNodeData(r"This is `\{attr\}`"),
...
#     expected_nodes = [
#         Node(
#             data=TextNodeData(r"This \_is\_ \text"),
...
#     expected_nodes = [
#         Node(
#             data=TextNodeData("A very *bold* text. Some code: `adict = {'a':5}`"),
